    ...
    def __init__(self):
        ...
        while self.begin:
            ...
            if self.front.choice():
                ...
                self.text = self.font2.render('Click the images',True,(0,0,255))
                self.text2 = self.font2.render('in the order that',True,(0,0,255))
                self.text3 = self.font2.render('they change',True,(0,0,255))
